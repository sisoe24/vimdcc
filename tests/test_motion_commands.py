...
from nuke_vim_editor.commands import motions
from nuke_vim_editor.handlers.handlers_normal import MotionHandler
...
@pytest.mark.parametrize('data', [
    ...
    MotionTest(['e'], 'foo bar foo bar', 0, 'fo', 2),
    MotionTest(['e', 'e'], 'foo bar foo bar', 0, 'foo ba', 6),
    MotionTest(['e', 'e', 'e'], 'foo bar foo bar', 0, 'foo bar fo', 10),
